...
var Ln = {};
Object.freeze(Ln);
var $o = typeof Proxy < "u", Do = /* @__PURE__ */ Object.toString();
function Xr() {
  $o || h(process.env.NODE_ENV !== "production" ? "`Proxy` objects are not available in the current environment. Please configure MobX to enable a fallback implementation.`" : "Proxy not available");
}
function et(e) {
...
function ri(e, t, n) {
  ...
  var r = new ge(e);
  return t !== Ue && Ja(r, t), n !== Ue && Ci(r, n), r;
}
function Uo(e, t) {
  return zi(e, t);
}
...
function ta(e, t) {
  ...
  return i(function() {
    var o = Ye(this)[m], a = fe({}, n.options_, {
      get: e,
      context: this
    });
...
function oa(e, t) {
  ...
  function a(s, l) {
    var c, u, d = Ye(s)[m], v = new Se(l, (c = (u = n.options_) == null ? void 0 : u.enhancer) != null ? c : xe, process.env.NODE_ENV !== "production" ? d.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
...
function ui(e, t, n) {
  ...
  return gt(e) ? e : C(e) ? S.object(e, t, n) : Array.isArray(e) ? S.array(e, t) : Ge(e) ? S.map(e, t) : ne(e) ? S.set(e, t) : typeof e == "object" && e !== null ? e : S.box(e, t);
}
Yr(ui, ci);
var wa = {
  box: function(t, n) {
  ...
  array: function(t, n) {
    var r = xt(n);
    return (f.useProxies === !1 || r.proxy === !1 ? ms : ss)(t, Pt(r), r.name);
  },
  map: function(t, n) {
    var r = xt(n);
  ...
  ref: /* @__PURE__ */ Z(ga),
  shallow: /* @__PURE__ */ Z(ma),
  deep: ci,
  struct: /* @__PURE__ */ Z(ba)
...
var Ca = "create", Se = /* @__PURE__ */ function(e) {
  function t(r, i, o, a, s) {
    var l;
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableValue@" + B() : "ObservableValue"), a === void 0 && (a = !0), s === void 0 && (s = Fe.default), l = e.call(this, o) || this, l.enhancer = void 0, l.name_ = void 0, l.equals = void 0, l.hasUnreportedChange_ = !1, l.interceptors_ = void 0, l.changeListeners_ = void 0, l.value_ = void 0, l.dehancer = void 0, l.enhancer = i, l.name_ = o, l.equals = s, l.value_ = i(r, void 0, o), process.env.NODE_ENV !== "production" && a && P() && Ce({
      type: Ca,
      object: l,
  ...
  return t.onBecomeStale_ = function() {
    ...
    return a && (this.value_ = o, process.env.NODE_ENV !== "production" && P() && Ce({
    ...
    this.keepAlive_ || ($n(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== U.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
...
function bi(e) {
  ...
  return t !== null ? (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved && f.trackingContext && (e.isBeingObserved = !0, e.onBO())), e.isBeingObserved) : (e.observers_.size === 0 && f.inBatch > 0 && mi(e), !1);
}
function _i(e) {
...
var Q = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    if (!this.isDisposed) {
      ...
      f.trackingContext = a, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && $n(this), Vt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && V({
        time: Date.now() - o
      }), L();
    }
    ...
    f.suppressReactionErrors ? process.env.NODE_ENV !== "production" && console.warn("[mobx] (error in reaction '" + this.name_ + "' suppressed, fix error of causing action below)") : console.error(o, r), process.env.NODE_ENV !== "production" && P() && Ce({
      type: "error",
      name: this.name_,
      message: o,
      error: "" + r
    ...
    this.isDisposed || (this.isDisposed = !0, this.isRunning || (M(), $n(this), L()));
...
function Pi(e, t, n) {
  var r, i, o;
  n === void 0 && (n = Ln), process.env.NODE_ENV !== "production" && ((!A(e) || !A(t)) && h("First and second argument to reaction should be functions"), C(n) || h("Third argument of reactions should be an object"));
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", s = Oe(a, n.onError ? qa(n.onError, t) : t), l = !n.scheduler && !n.delay, c = xi(n), u = !0, d = !1, v, g = n.compareStructural ? Fe.structural : n.equals || Fe.default, b = new Q(a, function() {
    u || l ? E() : d || (d = !0, c(E));
  ...
  function E() {
    if (d = !1, !b.isDisposed) {
      ...
      b.track(function() {
        ...
        N = u || !g(v, je), v = je;
      }), (u && n.fireImmediately || !u && N) && s(v, G, b), u = !1;
    }
  }
...
var mn = /* @__PURE__ */ oi("flow"), Qa = /* @__PURE__ */ oi("flow.bound", {
  bound: !0
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var s = this, l = arguments, c = ++Za, u = Oe(i + " - runid: " + c + " - init", r).apply(s, l), d, v = void 0, g = new Promise(function(b, E) {
      var N = 0;
      d = E;
      function G($) {
        v = void 0;
        var le;
        try {
          le = Oe(i + " - runid: " + c + " - yield " + N++, u.next).call(u, $);
        } catch (be) {
          return E(be);
        }
        Qe(le);
      ...
      function je($) {
        ...
        var le;
        try {
          le = Oe(i + " - runid: " + c + " - yield " + N++, u.throw).call(u, $);
        } catch (be) {
          return E(be);
        }
        Qe(le);
...
function es(e, t) {
  return e ? Xe(e) || !!e[m] || zn(e) || Ft(e) || ln(e) : !1;
}
function gt(e) {
...
function is(e, t) {
  var n, r;
  return Xr(), e = Ye(e, t), (r = (n = e[m]).proxy_) != null ? r : n.proxy_ = new Proxy(e, rs);
}
function R(e) {
...
function Nt(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!C(e) && !C(Object.getPrototypeOf(e)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"), Xe(e) && h("makeAutoObservable can only be used on objects not already made observable")), C(e) ? Di(e, e, t, n) : (Ie(function() {
    var r = Ye(e, n)[m];
    if (!e[bn]) {
      var i = Object.getPrototypeOf(e), o = new Set([].concat(ht(e), ht(i)));
      o.delete("constructor"), o.delete(m), en(i, bn, o);
    }
...
var or = "splice", F = "update", os = 1e4, as = {
  get: function(t, n) {
    var r = t[m];
    return n === m ? r : n === "length" ? r.getArrayLength_() : typeof n == "string" && !isNaN(n) ? r.get_(parseInt(n)) : H(Ht, n) ? Ht[n] : t[n];
  },
  set: function(t, n, r) {
    var i = t[m];
...
var cs = {}, ue = "add", Kt = "delete", Ii = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = xe), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[m] = cs, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || h(18), Ie(function() {
  ...
  return t.has_ = function(r) {
    ...
    var i = this;
    return me(r) && (r = new Map(r)), ie(function() {
    ...
    return ie(function() {
      ...
      for (var g = ze(o.entries()), b; !(b = g()).done; ) {
        var E = b.value, N = E[0], G = E[1], je = i.data_.has(N);
      ...
      if (!s)
        if (i.data_.size !== a.size)
          ...
          for (var $ = i.data_.keys(), le = a.keys(), be = $.next(), Zn = le.next(); !be.done; ) {
            if (be.value !== Zn.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            be = $.next(), Zn = le.next();
...
}(), me = /* @__PURE__ */ ke("ObservableMap", Ii);
function ar(e) {
...
var ds = {}, Ri = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = xe), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[m] = ds, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || h(22), this.enhancer_ = function(a, s) {
      return r(a, s, i);
    }, Ie(function() {
...
function Ye(e, t) {
  var n;
  if (process.env.NODE_ENV !== "production" && t && Xe(e) && h("Options can't be provided for already observable objects."), H(e, m))
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (C(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject", i = new kn(e, /* @__PURE__ */ new Map(), String(r), _a(t));
  return en(e, m, i), e;
}
...
var qn = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    ...
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), a === void 0 && (a = !1), s = e.call(this) || this, Ie(function() {
      ...
      l.proxy_ = s, Qr(s, m, l), r && r.length && s.spliceWithArray(0, 0, r), vs && Object.defineProperty(s, "0", hs);
    }), s;
  }
  ni(t, e);
  var n = t.prototype;
...
function Ui(e, t) {
  if (e || h(29), zn(e) || ln(e) || Ft(e) || me(e) || J(e))
    return e;
  if (e[m])
    return e[m];
  h(24, e);
...
function vr(e) {
  return cn(e) ? e.slice() : Ge(e) || me(e) || ne(e) || J(e) ? Array.from(e.entries()) : e;
}
var pr, bs = ((pr = Mn().Iterator) == null ? void 0 : pr.prototype) || {};
function Wn(e) {
  return e[Symbol.iterator] = _s, Object.assign(Object.create(bs), e);
}
function _s() {
  return this;
}
...
function Hi() {
  if (!(!Ct && (Ct = Array.from(document.querySelectorAll("*")).flatMap((e) => Object.keys(e)).filter((e) => e.startsWith("__reactFiber$")).map((e) => e.replace("__reactFiber$", "")).find((e) => e), !Ct)))
    return Ct;
}
function st(e) {
  const t = e.type;
...
function Rs() {
  const e = Array.from(document.querySelectorAll("body > *")).flatMap((n) => n[Is()]).find((n) => n), t = $e(e);
  return $e(t?.child);
}
function js(e) {
  const t = [];
...
const un = async (e, t, n) => window.Vaadin.copilot.comm(e, t, n), he = "copilot-", zs = "24.7.0.beta1", Hc = "attention-required", Kc = "https://plugins.jetbrains.com/plugin/23758-vaadin", qc = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode";
function Wc(e) {
...
class Js {
  ...
  setActive(t, n) {
    this.active = t, t && (this.activatedAtLeastOnce || (mt("activate"), this.idePluginState?.active && mt("plugin-active", {
...
const eu = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, Ys = (e) => {
  const t = [];
  let n = Zs(e);
  for (; n; )
...
class tl {
  constructor() {
    this.dismissedNotifications = [], this.termsSummaryDismissed = !1, this.activationButtonPosition = null, this.paletteState = null, this.activationShortcut = !0, this.activationAnimation = !0, this.recentSwitchedUsernames = [], this.newVersionPreReleasesVisible = !1, Nt(this), this.initializer = new el(), this.initializer.promise.then(() => {
      Pi(
        () => JSON.stringify(this),
        () => {
...
class nl {
  ...
  loadPreviewConfiguration() {
    un(`${he}get-preview`, {}, (t) => {
      ...
      Promise.resolve().then(() => Yl).then((n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Yn = globalThis, Xt = Yn.trustedTypes, Cr = Xt ? Xt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, no = "$lit$", ce = `lit$${Math.random().toFixed(9).slice(2)}$`, ro = "?" + ce, bl = `<${ro}>`, Te = document, bt = () => Te.createComment(""), _t = (e) => e === null || typeof e != "object" && typeof e != "function", Xn = Array.isArray, _l = (e) => Xn(e) || typeof e?.[Symbol.iterator] == "function", yn = `[ 	
\f\r]`, nt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $r = /-->/g, Dr = />/g, ye = RegExp(`>|${yn}(?:([^\\s"'>=/]+)(${yn}*=${yn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Tr = /'/g, kr = /"/g, io = /^(?:script|style|textarea|title)$/i, oo = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Be = oo(1), ou = oo(2), pe = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), Vr = /* @__PURE__ */ new WeakMap(), Ae = Te.createTreeWalker(Te, 129);
function ao(e, t) {
...
const yl = (e, t) => {
  ...
  for (let s = 0; s < n; s++) {
    const l = e[s];
    let c, u, d = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, u = a.exec(l), u !== null); ) v = a.lastIndex, a === nt ? u[1] === "!--" ? a = $r : u[1] !== void 0 ? a = Dr : u[2] !== void 0 ? (io.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = ye) : u[3] !== void 0 && (a = ye) : a === ye ? u[0] === ">" ? (a = i ?? nt, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? ye : u[3] === '"' ? kr : Tr) : a === kr || a === Tr ? a = ye : a === $r || a === Dr ? a = nt : (a = ye, i = void 0);
    const g = a === ye && e[s + 1].startsWith("/>") ? " " : "";
    o += a === nt ? l + bl : d >= 0 ? (r.push(c), l.slice(0, d) + no + l.slice(d) + ce + g) : l + ce + (d === -2 ? s : g);
  }
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(no)) {
          const v = u[a++], g = i.getAttribute(d).split(ce), b = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: o, name: b[2], strings: g, ctor: b[1] === "." ? El : b[1] === "?" ? Ol : b[1] === "@" ? Al : hn }), i.removeAttribute(d);
        ...
        if (io.test(i.tagName)) {
          ...
          if (v > 0) {
            ...
            for (let g = 0; g < v; g++) i.append(d[g], bt()), Ae.nextNode(), l.push({ type: 2, index: ++o });
            i.append(d[v], bt());
          }
        }
...
class Ze {
  ...
  k(t) {
    ...
    const n = this._$AH;
    let r, i = 0;
    for (const o of t) i === n.length ? n.push(r = new Ze(this.O(bt()), this.O(bt()), this, this.options)) : r = n[i], r._$AI(o), i++;
...
const Pl = (e, t, n) => {
  ...
  if (i === void 0) {
    ...
    r._$litPart$ = i = new Ze(t.insertBefore(bt(), o), o, void 0, n ?? {});
  }
  return i._$AI(e), i;
};
/**
...
function Tl() {
  Ee.push(import("./copilot-log-plugin-BPOw4Hvh.js")), Ee.push(import("./copilot-info-plugin-Dl1CjrCd.js")), Ee.push(import("./copilot-features-plugin-CBczGyAu.js")), Ee.push(import("./copilot-feedback-plugin-DBXq9_Gu.js")), Ee.push(import("./copilot-shortcuts-plugin-Cupj1L9U.js"));
}
function kl() {
  {
...
const rt = window.Vaadin.copilot.overlayManager, cu = {
...
const Rl = lo(Rn), vn = window.Vaadin.copilot._machineState;
if (!vn)
  throw new Error("Trying to use stored machine state before it was initialized");
const jl = 5e3;
let jr = 1;
function uo(e) {
  p.notifications.includes(e) && (e.dontShowAgain && e.dismissId && Ml(e.dismissId), p.removeNotification(e), y.emit("notification-dismissed", e));
}
function fo(e) {
  return vn.getDismissedNotifications().includes(e);
}
function Ml(e) {
  fo(e) || vn.addDismissedNotification(e);
}
function Ll(e) {
  return !(e.dismissId && (fo(e.dismissId) || p.notifications.find((t) => t.dismissId === e.dismissId)));
}
function ho(e) {
  Ll(e) && Ul(e);
}
function Ul(e) {
  ...
  p.setNotifications([...p.notifications, n]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    uo(n);
  }, e.delay ?? jl), y.emit("notification-shown", e);
}
...
}, Kl = (e, t) => e.error ? (ql(e.error, t), !0) : !1, vo = (e, t, n, r) => {
  dn({
    type: Re.ERROR,
    message: e,
    details: Gi(
...
${n}` : "")
  ...
  wn(t) && t.suggestRestart && Bl() && (r.details = Gi(
    Be`${e}<br />${n}
        <button
          style="align-self:start;padding:0"
          @click=${(o) => {
      const a = o.target;
      a.disabled = !0, a.innerText = "Restarting...", Fl();
    }}>
          Restart now
        </button>`
  ), r.delay = 3e4), dn(r);
...
function po() {
  ...
  Array.isArray(t) && jn.push(...t), go((n) => jn.push(n));
}
const jn = [];
function go(e) {
  const t = window.Vaadin.ConsoleErrors;
  window.Vaadin.ConsoleErrors = {
    push: (n) => {
      n[0].type !== void 0 && n[0].message !== void 0 ? e({
        ...
        details: n[0].details,
        link: n[0].link
      }) : e({ type: Re.ERROR, message: n.map((r) => Gl(r)).join(" "), internal: !1 }), t.push(n);
    }
  };
}
function Gl(e) {
...
const Yl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  handleErrorDuringOperation: Hl,
  handleServerOperationErrorIfNeeded: Kl,
  installErrorHandlers: po,
  showNotReactFlowProject: Jl
...
const bo = () => {
  Xl().then((e) => p.setUserInfo(e)).catch((e) => se("Failed to load userInfo", e));
}, Xl = async () => un(`${he}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Zl = async () => Wi(() => p.userInfo), uu = async () => (await Zl()).vaadiner;
...
const ic = (e) => {
  ...
  } else !Lr(e) && !t && oc(e) ? (y.emit("delete-selected", {}), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "d" && !t ? (y.emit("duplicate-selected", {}), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "b" && !t ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), e.preventDefault(), e.stopPropagation()) : (e.ctrlKey || e.metaKey) && e.key === "z" ? p.idePluginState?.supportedActions?.find((n) => n === "undo") && (y.emit("undoRedo", { undo: !e.shiftKey }), e.preventDefault(), e.stopPropagation()) : De(e.target) && !Lr(e) && !rc(e) && y.emit("keyboard-event", { event: e });
}, oc = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, ee = tc(), du = {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _o = Symbol.for(""), ac = (e) => {
  if (e?.r === _o) return e?._$litStatic$;
}, yo = (e) => ({ _$litStatic$: e, r: _o }), zr = /* @__PURE__ */ new Map(), sc = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], s = [];
  let l, c = 0, u = !1;
  for (; c < r; ) {
    for (l = t[c]; c < r && (o = n[c], (i = ac(o)) !== void 0); ) l += i + t[++c], u = !0;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: lc } = Nl, Br = () => document.createComment(""), ot = (e, t, n) => {
  const r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (n === void 0) {
    const o = r.insertBefore(Br(), i), a = r.insertBefore(Br(), i);
    n = new lc(o, a, e, e.options);
  } else {
  ...
  return n;
}, we = (e, t, n = e) => (e._$AI(t, n), e), cc = {}, uc = (e, t = cc) => e._$AH = t, dc = (e) => e._$AH, On = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Fr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    ...
    else if (s[d] === a[b]) l[b] = we(i[d], o[b]), ot(e, l[b + 1], i[d]), d++, b--;
    else if (s[v] === a[g]) l[g] = we(i[v], o[g]), ot(e, i[d], i[v]), v--, g++;
    else if (c === void 0 && (c = Fr(a, g, b), u = Fr(s, d, v)), c.has(s[d])) if (c.has(s[v])) {
    ...
    return this.ut = a, uc(e, l), pe;
  }
}), Rt = /* @__PURE__ */ new Map(), fc = (e) => {
...
const mc = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Hr = { randomUUID: mc };
function Eo(e, t, n) {
  if (Hr.randomUUID && !e)
    return Hr.randomUUID();
  e = e || {};
  const r = e.random ?? e.rng?.() ?? gc();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, vc(r);
}
const jt = [], lt = [], vu = async (e, t, n) => {
  let r, i;
  t.reqId = Eo();
...
const qr = new Tc(), kc = "copilot-development-setup-user-guide";
function mu() {
  mt("use-dev-workflow-guide"), ae.updatePanel(kc, { floating: !0 });
}
function So() {
  const e = p.jdkInfo;
...
function bu() {
  const e = p.jdkInfo;
  return !e || So() !== "success" ? "none" : e.jrebel ? "jrebel" : e.runningWitHotswap ? "hotswap" : "none";
}
function Vc() {
...
class Rc {
  ...
  includeReactNode(t) {
    return st(t) === "PreconfiguredAuthProvider" || st(t) === "RouterProvider" ? !1 : br(t) || Us(t);
  }
  ...
  async isInitializedInProjectSources(t) {
    ...
    if (!this.flowNodesInSource[i]) {
      const o = await un("copilot-get-component-source-info", { uiId: i }, (a) => a.data);
      o.error && se("Failed to get component source info", o.error), window.Vaadin.copilot.customComponentHandler.setData(
        i,
  ...
  async addToTree(t, n) {
    ...
    if (n)
      ...
      if (!o)
        return !(t instanceof Element) && Ki(t) ? (ho({
          type: Re.WARNING,
  ...
  generateNodeFromFiber(t, n) {
    const r = br(t) ? Yt(t) : void 0, i = n?.children.length ?? 0;
    return {
      node: t,
      parent: n,
      element: r,
...
let Jr = class extends Dl {
  constructor() {
    ...
    }, this.operationInProgressCursorUpdateDebounceFunc = Dc(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-CV4gRdcc.js"), await import("./copilot-init-step2-EsNXQWIA.js"), Gs(), Tl(), this.tabIndex = 0, Tt.hostConnectedCallback(), window.addEventListener("keydown", Ur), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), po(), this.initialized = !0, Ic();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    Tt.activate(), qr.copilotActivated(), Vl(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.addEventListener("mouseover", this.mouseOverListener), rt.onCopilotActivation(), await jc(), mo.loadPreviewConfiguration(), this.active = !0;
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), Tt.deactivate(), qr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), document.documentElement.removeEventListener("mouseover", this.mouseOverListener), rt.onCopilotDeactivation(), this.active = !1;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Tt.hostDisconnectedCallback(), window.removeEventListener("keydown", Ur), y.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), rt.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  render() {
    return Be`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${hc()}
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), _c();
  }

import { q as S, M as L, b as g, j as a, C as H, r as d, u as le, v as D, w as B, x as M, O as W, A as I, y as m, z as l, B as fe, D as be, F as we, G as V, H as ee, E as p, I as ye, k as de, l as xe, P as Pe, J as Ie, V as Ae, K as ce, L as $, N as Se, Q as G, R as K, S as Ce, T as U, U as ke, W as ze, X as he, Y as te, Z as pe, _ as $e, $ as De, a0 as Le, a1 as Ee, a2 as Re, a3 as Me, a4 as Te, a5 as Oe, a6 as je } from "./copilot-8jDc2fEd.js";
import { n as _, r as C } from "./state-CHU89Gjp.js";
import { e as k, m as ge } from "./overlay-monkeypatch-DwAlzMri.js";
import { i as c } from "./icons-C7DRTnby.js";
...
var He = Object.defineProperty, Ue = Object.getOwnPropertyDescriptor, z = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? Ue(t, n) : t, s = e.length - 1, r; s >= 0; s--)
...
let P = class extends L {
    ...
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.documentMouseUpListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${o}px`), H.saveDrawerSize(this.position, o), i = { width: o };
        } else if (this.position === "left") {
          const o = t;
          this.style.setProperty("--size", `${o}px`), H.saveDrawerSize(this.position, o), i = { width: o };
        } else if (this.position === "bottom") {
          const o = document.body.clientHeight - n;
          this.style.setProperty("--size", `${o}px`), H.saveDrawerSize(this.position, o), i = { height: o };
        }
      ...
      if (!le(this.getBoundingClientRect(), t, n)) {
  ...
  connectedCallback() {
    ...
    const e = H.getDrawerSize(this.position);
...
var Be = Object.defineProperty, Ne = Object.getOwnPropertyDescriptor, ue = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? Ne(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = (i ? r(t, n, o) : r(o)) || o);
  return i && o && Be(t, n, o), o;
};
...
const x = new Je();
var Ve = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, T = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? Fe(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = (i ? r(t, n, o) : r(o)) || o);
  return i && o && Ve(t, n, o), o;
};
const ie = "https://github.com/JetBrains/JetBrainsRuntime/releases";
function qe(e, t) {
  if (!t)
    return !0;
...
let w = class extends L {
  ...
  render() {
    ...
    return l`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => d.updatePanel(Z.tag, { floating: !1 })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = Ie, n = "Install from JetBrains Marketplace") : e.vscode && (t = Ae, n = "Install from VSCode Marketplace"), l`
      <div>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = a.jdkInfo?.extendedClassDefCapable, n = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === ne;
    return l`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && qe("1.3.0", a.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : p}
              ...
              <li>
                ${e.intellij || e.vscode ? l`If there is a problem, you can manually
                      <a target="_blank" href="${ie}">download JetBrains Runtime JDK</a> and set up
                      your debug configuration to use it.` : l`<a target="_blank" href="${ie}">Download JetBrains Runtime JDK</a> and set up
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], de(`${Pe}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (xe("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, ne];
    });
  }
...
window.Vaadin.copilot.plugins.push(Xe);
d.addPanel(Z);
...
oe = We([
  S("copilot-activation-button-development-workflow")
], oe);
var Ge = Object.getOwnPropertyDescriptor, Ke = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? Ge(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = r(o) || o);
  return o;
};
...
se = Ke([
  S("copilot-activation-button-user-info")
], se);
function v(e) {
  return ve("vaadin-menu-bar-item", e);
}
function q(e) {
  return ve("vaadin-context-menu-item", e);
}
function ve(e, t) {
  ...
  if (t.style && (n.className = t.style), t.icon)
    if (typeof t.icon == "string") {
      ...
      n.append(Ze(t.icon.strings[0]));
  if (t.label) {
    const i = document.createElement("span");
    i.className = "label", i.innerHTML = t.label, n.append(i);
  } else if (t.component) {
    const i = Se(t.component) ? t.component : document.createElement(t.component);
    n.append(i);
  }
  if (t.hint) {
    const i = document.createElement("span");
...
function me(e) {
  return de("copilot-switch-user", { username: e }, (t) => t.data.error ? (G({ type: K.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var Qe = Object.defineProperty, et = Object.getOwnPropertyDescriptor, N = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? et(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = (i ? r(t, n, o) : r(o)) || o);
  return i && o && Qe(t, n, o), o;
};
const tt = 8;
function it() {
  ...
  return e.label = "Username to Switch To", e.style.width = "100%", e.autocomplete = "off", e.addEventListener("click", async (t) => {
    ...
    if (t.stopPropagation(), t.key === "Enter") {
      const n = e.value;
      if (await me(n)) {
        const o = m.getRecentSwitchedUsernames();
        m.setRecentSwitchedUsernames(ze([n, ...o])), window.location.reload();
      }
    }
  }), e;
}
let j = class extends L {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: n } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(n - this.initialMouseDownPosition.y) > tt;
      }
      ...
      if (!o)
        return !1;
      const s = o.getBoundingClientRect(), r = i.getBoundingClientRect(), h = Math.min(s.x, r.x), u = Math.min(s.y, r.y), f = Math.max(s.width, r.width), y = s.height + r.height;
      return le(new DOMRect(h, u, f, y), e.clientX, e.clientY);
  ...
  generateItems() {
    const e = a.active, t = e && a.userInfo?.copilotProjectCannotLeaveLocalhost !== !0, n = e && !!a.idePluginState?.supportedActions?.find((s) => s === "undo"), i = [];
    if (R.springSecurityEnabled) {
      const s = m.getRecentSwitchedUsernames();
      i.push(
        ...s.map((r) => ({
          component: v({
            label: r
          ...
          action: async () => {
            await me(r) && window.location.reload();
          }
        }))
        ...
        children: [
          ...
          },
          {
            component: v({
              ...
              hint: m.isActivationShortcut() ? U.toggleCopilot : void 0
            }),
            action: () => {
  ...
  firstUpdated() {
    this.setMenuBarOnClick(), ge(this.shadowRoot);
  }
};
N([
  k("vaadin-menu-bar")
...
var nt = Object.defineProperty, ot = Object.getOwnPropertyDescriptor, E = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? ot(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = (i ? r(t, n, o) : r(o)) || o);
  return i && o && nt(t, n, o), o;
};
const b = "resize-dir", X = "floating-resizing-active";
let A = class extends L {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let h = "";
      n < r ? o < r ? (h = "nw-resize", this.setAttribute(b, "top left")) : s < r ? (h = "sw-resize", this.setAttribute(b, "bottom left")) : (h = "col-resize", this.setAttribute(b, "left")) : i < r ? o < r ? (h = "ne-resize", this.setAttribute(b, "top right")) : s < r ? (h = "se-resize", this.setAttribute(b, "bottom right")) : (h = "col-resize", this.setAttribute(b, "right")) : s < r ? (h = "row-resize", this.setAttribute(b, "bottom")) : o < r && (h = "row-resize", this.setAttribute(b, "top")), h !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", h)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(b)), this.toggleAttribute(X, h !== "");
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(X), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(b)));
      ...
      const { width: t, height: n } = this.getBoundingClientRect(), { left: i, top: o, bottom: s, right: r } = x.anchor(this), h = window.getComputedStyle(this.container), u = Number.parseInt(h.borderTopWidth, 10), f = Number.parseInt(h.borderBottomWidth, 10);
      ...
      e.button === 0 && (d.bringToFront(this.panelInfo.tag), !this.hasAttribute(b) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
    ...
    }, this.startDraggingDebounce = he(this.startDragging, 200), this.draggingEventListener = (e) => {
      const t = x.dragging(this, e);
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), te(this), this.panelInfo?.floating)
  ...
  setResizePosition(e, t, n) {
    const i = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, r = 0, h = window.innerHeight, u = Math.max(o, Math.min(s, t)), f = Math.max(r, Math.min(h, n));
    if (e === "left")
      ...
      const y = i.top - f + i.height;
      this.setFloatingResizeDirectionProps("top", f, void 0, y);
    } else if (e === "bottom") {
      const y = f - i.bottom + i.height;
      this.setFloatingResizeDirectionProps("bottom", f, void 0, y);
    }
  }
  willUpdate(e) {
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      ...
      te(this), d.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: n + 1 });
    }
...
g.on("undoRedo", (e) => {
  const n = { files: e.detail.files ?? Le(), uiId: Ee() }, i = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  Re(o), st(W.RedoUndo), g.send(i, n);
});
var at = Object.getOwnPropertyDescriptor, rt = (e, t, n, i) => {
  for (var o = i > 1 ? void 0 : i ? at(t, n) : t, s = e.length - 1, r; s >= 0; s--)
    (r = e[s]) && (o = r(o) || o);
  return o;
};
...
re ? re.add((e, t) => {
  e === "loading" && t === "connected" && a.active && Q();

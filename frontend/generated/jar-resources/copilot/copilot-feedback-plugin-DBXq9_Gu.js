import { z as d, b as c, r as h, a2 as f, s as v, P as b, D as m, q as g } from "./copilot-8jDc2fEd.js";
import { r as p } from "./state-CHU89Gjp.js";
import { m as y, e as k } from "./overlay-monkeypatch-DwAlzMri.js";
import { B as x } from "./base-panel-BlK0Zn5e.js";
import { i as w } from "./icons-C7DRTnby.js";
...
let i = class extends x {
  ...
  openGithub(e, t) {
    ...
    const l = e.replace(/\n/g, "%0A"), n = `${t.items.find((r) => r.value === this.type)?.ghTitle}`, a = t.description !== "" ? t.description : D, s = F.replace("{description}", a).replace("{versionsInfo}", l);
